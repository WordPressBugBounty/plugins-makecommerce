...
final class ModuleNode extends Node
{
    ...
    public function __construct(Node $body, ?AbstractExpression $parent, Node $blocks, Node $macros, Node $traits, $embeddedTemplates, Source $source)
    {
        if (!$body instanceof BodyNode) {
            makecommerceprefix_trigger_deprecation('twig/twig', '3.12', \sprintf('Not passing a "%s" instance as the "body" argument of the "%s" constructor is deprecated.', BodyNode::class, static::class));
        }
        if (!$embeddedTemplates instanceof Node) {
            makecommerceprefix_trigger_deprecation('twig/twig', '3.21', \sprintf('Not passing a "%s" instance as the "embedded_templates" argument of the "%s" constructor is deprecated.', Node::class, static::class));
    ...
    protected function compileClassHeader(Compiler $compiler)
    {
        ...
        if (!$this->getAttribute('index')) {
            $compiler
                ->write("use MakeCommercePrefix\Twig\Environment;\n")
                ->write("use MakeCommercePrefix\Twig\Error\LoaderError;\n")
                ->write("use MakeCommercePrefix\Twig\Error\RuntimeError;\n")
                ->write("use MakeCommercePrefix\Twig\Extension\CoreExtension;\n")
                ->write("use MakeCommercePrefix\Twig\Extension\SandboxExtension;\n")
                ->write("use MakeCommercePrefix\Twig\Markup;\n")
                ->write("use MakeCommercePrefix\Twig\Sandbox\SecurityError;\n")
                ->write("use MakeCommercePrefix\Twig\Sandbox\SecurityNotAllowedTagError;\n")
                ->write("use MakeCommercePrefix\Twig\Sandbox\SecurityNotAllowedFilterError;\n")
                ->write("use MakeCommercePrefix\Twig\Sandbox\SecurityNotAllowedFunctionError;\n")
                ->write("use MakeCommercePrefix\Twig\Source;\n")
                ->write("use MakeCommercePrefix\Twig\Template;\n")
                ->write("use MakeCommercePrefix\Twig\TemplateWrapper;\n")
                ->write("\n")
            ;
        }
        $compiler
