...
use MakeCommercePrefix\Twig\DeprecatedCallableInfo;
...
use MakeCommercePrefix\Twig\ExpressionParser\Infix\ArrowExpressionParser;
use MakeCommercePrefix\Twig\ExpressionParser\Infix\AssignmentExpressionParser;
use MakeCommercePrefix\Twig\ExpressionParser\Infix\BinaryOperatorExpressionParser;
use MakeCommercePrefix\Twig\ExpressionParser\Infix\ConditionalTernaryExpressionParser;
use MakeCommercePrefix\Twig\ExpressionParser\Infix\DotExpressionParser;
use MakeCommercePrefix\Twig\ExpressionParser\Infix\FilterExpressionParser;
use MakeCommercePrefix\Twig\ExpressionParser\Infix\FunctionExpressionParser;
use MakeCommercePrefix\Twig\ExpressionParser\Infix\IsExpressionParser;
use MakeCommercePrefix\Twig\ExpressionParser\Infix\IsNotExpressionParser;
use MakeCommercePrefix\Twig\ExpressionParser\Infix\SquareBracketExpressionParser;
...
use MakeCommercePrefix\Twig\ExpressionParser\Prefix\GroupingExpressionParser;
use MakeCommercePrefix\Twig\ExpressionParser\Prefix\LiteralExpressionParser;
use MakeCommercePrefix\Twig\ExpressionParser\Prefix\UnaryOperatorExpressionParser;
use MakeCommercePrefix\Twig\Markup;
use MakeCommercePrefix\Twig\Node\Expression\AbstractExpression;
use MakeCommercePrefix\Twig\Node\Expression\Binary\AddBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\AndBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\BitwiseAndBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\BitwiseOrBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\BitwiseXorBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\ConcatBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\DivBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\ElvisBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\EndsWithBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\EqualBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\FloorDivBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\GreaterBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\GreaterEqualBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\HasEveryBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\HasSomeBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\InBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\LessBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\LessEqualBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\MatchesBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\ModBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\MulBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\NotEqualBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\NotInBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\NotSameAsBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\NullCoalesceBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\OrBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\PowerBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\RangeBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\SameAsBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\SpaceshipBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\StartsWithBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\SubBinary;
use MakeCommercePrefix\Twig\Node\Expression\Binary\XorBinary;
use MakeCommercePrefix\Twig\Node\Expression\BlockReferenceExpression;
use MakeCommercePrefix\Twig\Node\Expression\Filter\DefaultFilter;
use MakeCommercePrefix\Twig\Node\Expression\FunctionNode\EnumCasesFunction;
use MakeCommercePrefix\Twig\Node\Expression\FunctionNode\EnumFunction;
use MakeCommercePrefix\Twig\Node\Expression\GetAttrExpression;
use MakeCommercePrefix\Twig\Node\Expression\ParentExpression;
use MakeCommercePrefix\Twig\Node\Expression\Test\ConstantTest;
use MakeCommercePrefix\Twig\Node\Expression\Test\DefinedTest;
use MakeCommercePrefix\Twig\Node\Expression\Test\DivisiblebyTest;
use MakeCommercePrefix\Twig\Node\Expression\Test\EvenTest;
use MakeCommercePrefix\Twig\Node\Expression\Test\NullTest;
use MakeCommercePrefix\Twig\Node\Expression\Test\OddTest;
use MakeCommercePrefix\Twig\Node\Expression\Test\SameasTest;
use MakeCommercePrefix\Twig\Node\Expression\Test\TrueTest;
use MakeCommercePrefix\Twig\Node\Expression\Unary\NegUnary;
use MakeCommercePrefix\Twig\Node\Expression\Unary\NotUnary;
use MakeCommercePrefix\Twig\Node\Expression\Unary\PosUnary;
...
use MakeCommercePrefix\Twig\Sandbox\SecurityNotAllowedMethodError;
use MakeCommercePrefix\Twig\Sandbox\SecurityNotAllowedPropertyError;
use MakeCommercePrefix\Twig\Source;
use MakeCommercePrefix\Twig\Template;
use MakeCommercePrefix\Twig\TemplateWrapper;
use MakeCommercePrefix\Twig\TokenParser\ApplyTokenParser;
use MakeCommercePrefix\Twig\TokenParser\BlockTokenParser;
use MakeCommercePrefix\Twig\TokenParser\DeprecatedTokenParser;
use MakeCommercePrefix\Twig\TokenParser\DoTokenParser;
use MakeCommercePrefix\Twig\TokenParser\EmbedTokenParser;
use MakeCommercePrefix\Twig\TokenParser\ExtendsTokenParser;
use MakeCommercePrefix\Twig\TokenParser\FlushTokenParser;
use MakeCommercePrefix\Twig\TokenParser\ForTokenParser;
use MakeCommercePrefix\Twig\TokenParser\FromTokenParser;
use MakeCommercePrefix\Twig\TokenParser\GuardTokenParser;
use MakeCommercePrefix\Twig\TokenParser\IfTokenParser;
use MakeCommercePrefix\Twig\TokenParser\ImportTokenParser;
use MakeCommercePrefix\Twig\TokenParser\IncludeTokenParser;
use MakeCommercePrefix\Twig\TokenParser\MacroTokenParser;
use MakeCommercePrefix\Twig\TokenParser\SetTokenParser;
use MakeCommercePrefix\Twig\TokenParser\TypesTokenParser;
use MakeCommercePrefix\Twig\TokenParser\UseTokenParser;
use MakeCommercePrefix\Twig\TokenParser\WithTokenParser;
use MakeCommercePrefix\Twig\TwigFilter;
use MakeCommercePrefix\Twig\TwigFunction;
use MakeCommercePrefix\Twig\TwigTest;
use MakeCommercePrefix\Twig\Util\CallableArgumentsExtractor;
...
final class CoreExtension extends AbstractExtension
{
    ...
    public static function cycle($values, $position): mixed
    {
        if (!\is_array($values)) {
            ...
            if (!is_countable($values)) {
                ...
                makecommerceprefix_trigger_deprecation('twig/twig', '3.12', 'Passing a non-countable sequence of values to "%s()" is deprecated.', __METHOD__);
    ...
    public static function checkArrow(Environment $env, $arrow, $thing, $type)
    {
        ...
        makecommerceprefix_trigger_deprecation('twig/twig', '3.15', 'Passing a callable that is not a PHP \Closure as an argument to the "%s" %s is deprecated.', $thing, $type);
    }
