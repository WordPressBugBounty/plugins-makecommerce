...
use MakeCommercePrefix\Twig\Node\IncludeNode;
use MakeCommercePrefix\Twig\Node\Node;
use MakeCommercePrefix\Twig\Node\SandboxNode;
...
final class SandboxTokenParser extends AbstractTokenParser
{
    public function parse(Token $token): Node
    {
        ...
        makecommerceprefix_trigger_deprecation('twig/twig', '3.15', \sprintf('The "sandbox" tag is deprecated in "%s" at line %d.', $stream->getSourceContext()->getName(), $token->getLine()));
