...
abstract class IntegrationTestCase extends TestCase
{
    ...
    public function getTests($name, $legacyTests = false)
    {
        try {
            ...
            makecommerceprefix_trigger_deprecation('twig/twig', '3.13', 'Not overriding "%s::getFixturesDirectory()" in "%s" is deprecated. This method will be abstract in 4.0.', self::class, static::class);
