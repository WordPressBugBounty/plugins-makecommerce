...
use MakeCommercePrefix\GuzzleHttp\Handler\CurlHandler;
use MakeCommercePrefix\GuzzleHttp\Handler\CurlMultiHandler;
use MakeCommercePrefix\GuzzleHttp\Handler\Proxy;
use MakeCommercePrefix\GuzzleHttp\Handler\StreamHandler;
...
final class Utils
{
    ...
    public static function debugResource($value = null)
    {
        ...
        return \MakeCommercePrefix\GuzzleHttp\Psr7\Utils::tryFopen('php://output', 'w');
    }
    /**
