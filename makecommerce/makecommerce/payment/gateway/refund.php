                        ...
                        switch ( $status ) {
                            case "REFUNDED": 
                                $order->add_order_note( sprintf(
                                    /* translators: %s: Amount of refund */
                                    __( 'Refund completed for amount %s', 'wc_makecommerce_domain' ), $amount )
                                );
                                return true;
                                break;
                            case "PART_REFUNDED": 
                                $order->add_order_note( sprintf(
                                    /* translators: %s: Amount of partial refund */
                                    __( 'Partial refund completed for amount %s', 'wc_makecommerce_domain' ), $amount )
                                );
                                return true;
                                break;
                        }
