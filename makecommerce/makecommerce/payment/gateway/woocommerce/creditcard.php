...
trait Creditcard {
    ...
    public function generateCardForm( $orderId ) {
        ...
        $jsParams = array(
            ...
            'openonload' => 'true',
            'clientname' => (( string ) ( ( method_exists( $order, 'get_billing_first_name' )  ? $order->get_billing_first_name() : $order->billing_first_name ) . ' ' . ( method_exists( $order, 'get_billing_last_name' ) ? $order->get_billing_last_name() : $order->billing_last_name ) )),
            'email' => (( string ) ( method_exists( $order, 'get_billing_email' )  ? $order->get_billing_email() : $order->billing_email )),
