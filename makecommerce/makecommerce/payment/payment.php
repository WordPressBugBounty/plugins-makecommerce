...
class Payment {
	...
	/**
     * Add check for unsuccessful payment redirects
	...
	public static function check_payment( $settings = array() ) {
		...
		// Ignore with subscription method change as amounts do not match (0 vs order total)
		...
		if ( $order->get_status() !== 'active' && isset( $totalAmount ) && $totalAmount != $order->get_total() ) {
			...
			if ( $paymentStatus == 'COMPLETED' ) {
                ...
                //TODO: is this still required, woocommerce does not take care of this?
